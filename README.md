...
<section id="about" class="section-content">
    <h2>About Me</h2>
    <img src="niklas.jpg" alt="About Me Image" class="section-image">
...
<section id="favorites" class="section-content">
    ...
    <img src="denise-jans-HoqYAnwR-1g-unsplash.jpg" alt="Favorite Things Image" class="section-image">
    <ul>
...
<section id="projects" class="section-content">
    <h2>Fun Projects</h2>
    <img src="alexandre-daoust-JTPpib57Jgo-unsplash.jpg" alt="Fun Projects Image" class="section-image">
    <ul>
